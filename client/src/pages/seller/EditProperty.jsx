...
const EditProperty = () => {
  ...
  const removeNewImage = (i) => {
    ...
    setNewImagePreviews(newImagePreviews.filter((_, index) => index !== i));
  };
  ...
  const handleSubmit = async (e) => {
    ...
    Object.keys(formData).forEach((key) => {
      if (key === "amenities") {
        data.append("amenitiers", JSON.stringify(formData[key]));
            ...
            <div className={s.sectionContent}>
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Luxury 2BHK apartment at Gohpur"
                  className={s.input}
                  required
                />
              </div>
