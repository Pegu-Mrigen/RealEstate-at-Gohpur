            ...
            <div className={s.contentGroupLarge}>
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Luxury 3BHK Apartment at Gohpur Town"
                  className={s.input}
                  required
                />
              </div>
              ...
              <div className={s.contentGroupSmall}>
                ...
                <div>
                  ...
                  <input
                    ...
                    value={formData.area}
                    onChange={handleInputChange}
                    placeholder="e.g. Wrad no-1, Gohpur Town"
                    className={s.input}
                    required
                  />
                </div>
          ...
          <div className={s.section}>
            ...
            <div className={s.uploadArea}>
              ...
              <p className={s.uploadSubtext}>
                Upload upto 10 high-quality images (JPG, PNG)
              </p>
            </div>
