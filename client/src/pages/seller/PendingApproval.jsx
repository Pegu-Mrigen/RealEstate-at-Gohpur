  ...
  return (
    <div className={s.container}>
      ...
      <p className={s.description}>
        ...
        administration team. Approval usually takes less than 24 hours. Once
        verified you will have access to the full dashboard.
      </p>
      ...
      <div className={s.supportContainer}>
        <HiOutlineSupport size={18} /> Need help?{" "}
