      ...
      <main className={s.mainContainer}>
            ...
            {property.images.slice(1, 5).map((img, i) => (
              ...
              >
                ...
                {i === 3 && property.images.length > 5 && (
                  <div className={s.lightboxPtrevBtn}>
        ...
        {lightboxIndex !== null && (
          <div className={s.lightboxOverlay} onClick={closeLightbox}>
            <button className={s.lightboxCloseBtn}>
        ...
        <section className={s.similarSection}>
          <div className={s.similarHeader}>
            <div>
              <h2 className={s.similarTitle}>Smilar Properties</h2>
          ...
          <div className={s.similarGrid}>
            {similarProperties.length > 0 ? (
              ...
              <div className={s.similarEmptyState}>
                No silimar products found in this location.
              </div>
            )}
          </div>
        </section>
