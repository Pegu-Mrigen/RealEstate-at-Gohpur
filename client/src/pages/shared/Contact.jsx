      ...
      <div className={s.mainContainer}>
        <div className={s.header}>
          ...
          <p className={s.subheading}>
            ...
            hete to help you with anything you need.
          </p>
        </div>
            ...
            <div className={s.contactInfoCard}>
              <div className={`${s.contactItem} ${s.contactItemMarginBottom}`}>
                ...
                <div>
                  ...
                  <div className={s.contactDetail}>example@email.com</div>
                </div>
              </div>
              <div className={s.contactItem}>
                ...
                <div>
                  ...
                  <div className={s.contactDetail}>+91 9867543210</div>
                </div>
              </div>
            </div>
