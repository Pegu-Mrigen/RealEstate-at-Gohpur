...
const MyInquiries = () => {
  ...
  useEffect(() => {
    const fetchInquiries = async () => {
      ...
      try {
        ...
        const res = await axios.get(`${API_URL}/inquiry/${endpoint}`, {
          headers: {
  ...
  const handleStartChat = async (inq) => {
    try {
      ...
      alert("Failed to start chat.Please try again after sometime.");
    }
  };
    ...
    >
      ...
      <div
        className={`${s.containerFadeIn} ${
          user?.role !== "seller" ? s.py12pt12 : s.pt10
        }`}
      >
          ...
          <div className={s.cardPremiumPy24Px8TextCenter}>
            ...
            <p className={s.textMutedMb8}>
              {isSeller
                ...
                : "You haven't contacted the sellers yet. Interested in a property? Send an inquiry!"}
            </p>
